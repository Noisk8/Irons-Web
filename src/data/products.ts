...
export const products: DemoProduct[] = [
  ...
  { id:'p2', slug:'panel-arbol-de-luz', name:'Panel decorativo Árbol de Luz', category:'Decoración interior', categorySlug:'decoracion-interior', description:'Panel calado con silueta orgánica y retroiluminación cálida para crear un punto focal sereno.', price:0, image:'/productos/Panel decorativo “Árbol de Luz”.png', material:'Acero', finish:'Negro mate', color:'Negro y luz cálida', dimensions:'A medida', usage:'Interior', productionTime:'15 a 25 días hábiles', stock:0, customizable:true, requiresQuote:true, featured:true },
  { id:'p3', slug:'lampara-mural-geometrica', name:'Lámpara mural geométrica', category:'Iluminación', categorySlug:'iluminacion', description:'Aplique escultórico de geometría precisa que proyecta una luz ambiental cálida.', price:350000, image:'/productos/Lámpara mural geométrica.png', material:'Acero', finish:'Pintura electrostática', color:'Negro', dimensions:'32 × 28 × 12 cm', usage:'Interior', productionTime:'8 a 12 días hábiles', stock:7, customizable:true, requiresQuote:false, featured:true },
