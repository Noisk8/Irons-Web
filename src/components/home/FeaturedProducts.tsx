...
const demoProducts = [
  ...
  },
  {
    ...
    images: ['/productos/Lámpara mural geométrica.png'],
    tags: ['Nuevo'],
    status: 'ACTIVE',
  ...
  },
  {
    ...
    images: ['/productos/Soporte mural para toallas.png'],
    tags: ['Más vendido'],
    status: 'ACTIVE',
    isCustomizable: false,
    requiresQuote: false,
  ...
  },
  {
    ...
    images: ['/productos/Organizador mural para herramientas de jardín.png'],
    tags: ['Personalizable'],
    status: 'ACTIVE',
    isCustomizable: true,
    requiresQuote: false,
